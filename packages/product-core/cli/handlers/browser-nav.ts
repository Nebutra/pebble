...
// round-trip, even when Pebble is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "Pebble is not running" by the
