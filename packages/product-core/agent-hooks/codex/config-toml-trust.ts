...
// codex-rs/hooks/packages/product-core/engine/discovery.rs (command_hook_hash) +
// codex-rs/config/packages/product-core/fingerprint.rs (version_for_toml).
...
// hooks/packages/product-core/events/common.rs). Codex ignores matchers on
...
// potentially lowercased) and Pebble-built keys (forward-slash, realpathSync.native
