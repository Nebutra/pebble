...
const CLI_AGENT_COMMANDS = [
  'pebble worktree create --name auth-pr-1',
  'pebble worktree create --name auth-pr-2',
  'pebble orchestration dispatch --task pr1 --to w1',
  'pebble orchestration dispatch --task pr2 --to w2'
]
