...
import type * as ConfirmationDialogModule from '@/components/confirmation-dialog'
...
vi.mock('./ChecksPanel', async () => {
  const { useConfirmationDialog } = await vi.importActual<
    typeof ConfirmationDialogModule
  >('@/components/confirmation-dialog')

  return {
    default: function ChecksPanelMock() {
