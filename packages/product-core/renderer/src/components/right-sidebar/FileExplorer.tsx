...
function FileExplorerFiles(): React.JSX.Element {
  ...
  const runtimeDownloadContext = useMemo(
    () =>
      (activeRuntimeEnvironmentId || activeRepo?.connectionId) && activeWorktreeId && worktreePath
        ? {
            settings: activeRuntimeEnvironmentId ? { activeRuntimeEnvironmentId } : null,
