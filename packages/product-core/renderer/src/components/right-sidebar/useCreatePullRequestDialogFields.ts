...
type UseCreatePullRequestDialogFieldsOptions = {
  ...
  textGenerationUnavailableReason?: string | null
...
export function useCreatePullRequestDialogFields({
  ...
  textGenerationUnavailableReason,
  ...
  } else if (textGenerationUnavailableReason) {
    generateDisabledReason = textGenerationUnavailableReason
