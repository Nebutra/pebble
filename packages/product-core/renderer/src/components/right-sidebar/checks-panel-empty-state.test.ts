...
describe('getChecksPanelEmptyStateCopy', () => {
  ...
  it('prioritizes provider unavailable copy over unpublished branch guidance', () => {
    expect(
      getChecksPanelEmptyStateCopy({
        operationLabel: null,
        prRefreshStatus: 'error',
    ...
    ).toBe('Hosted review unavailable')
  })

  it('shows unavailable copy when hosted review creation is not supported in this environment', () => {
    expect(
      getChecksPanelEmptyStateCopy({
        operationLabel: null,
        prRefreshStatus: 'skipped',
        hostedReviewBlockedReason: 'unsupported_provider',
        hasUpstream: true
      })
    ).toEqual({
      title: 'Hosted review unavailable',
      description: 'Creating a pull request is not available in this environment yet.'
    })
  })
  ...
  it('uses merge request copy for GitLab review contexts', () => {
    expect(
      ...
      title: 'Hosted review unavailable',
      description: 'Creating a merge request is not available in this environment yet.'
    })
  })
