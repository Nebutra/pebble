...
describe('SourceControl host-context boundaries', () => {
  ...
  it('passes resolved PR-generation settings through local Tauri entry points', () => {
    expect(SOURCE_CONTROL_SOURCE).toContain('resolvedPullRequestAi')
    expect(SOURCE_CONTROL_SOURCE).toContain(
