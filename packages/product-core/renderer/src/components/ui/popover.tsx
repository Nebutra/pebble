...
// Why: app chrome such as the status bar and titlebar is visible UI, but Radix
// only sees the browser viewport unless we keep a small collision gutter.
const FLOATING_SURFACE_COLLISION_PADDING = 12
