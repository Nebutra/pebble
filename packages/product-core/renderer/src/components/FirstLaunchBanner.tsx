...
// `null`, i.e. users who installed Pebble before the telemetry release and
// have not yet resolved the notice.
//
// Why existing users see a notice at all (and new users do not): pre-
// telemetry users installed Pebble under a "no telemetry" social contract,
...
export function FirstLaunchBanner({
  ...
  const handleAcknowledge = async (): Promise<void> => {
    ...
    // `settings:changed` (see migration/electron-reference/src/main/ipc/telemetry.ts). Without an
