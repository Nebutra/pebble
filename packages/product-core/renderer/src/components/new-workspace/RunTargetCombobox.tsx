  ...
  const connectHost = useCallback(
    async (option: NeedsSetupProjectHostOption): Promise<void> => {
      ...
      try {
        ...
        // Why: the click handler can't await this, so a rejection would escape as an
        // unhandled promise rejection. Reporting it to the user is the caller's job.
        console.warn(
          '[run-target-combobox] connect failed:',
