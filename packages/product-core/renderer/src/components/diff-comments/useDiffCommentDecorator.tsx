...
export function useDiffCommentDecorator({
  ...
  useEffect(() => {
    ...
    plus.type = 'button'
    plus.className = 'pebble-diff-comment-add-btn'
      ...
      rangeDecorationIds = editor.deltaDecorations(rangeDecorationIds, [
        {
          ...
          options: {
            isWholeLine: true,
            className: 'pebble-diff-comment-range-highlight'
          }
        }
      ])
    }
  ...
  useEffect(() => {
            ...
            headerActions={
              worktreeId && comment.author === undefined ? (
                <NotesSendMenu
                  ...
                  triggerClassName="pebble-diff-comment-edit"
    ...
    editor.changeViewZones((accessor) => {
      ...
      for (const c of relevant) {
        ...
        dom.className = 'pebble-diff-comment-inline'
