...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="pebble-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="pebble-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="pebble-diff-comment-popover-label">
          {title ??
