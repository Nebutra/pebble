...
// "attach to a still-running TUI" — but Pebble restores scrollback against a
...
// font gives Pebble a known-good fallback even on clean systems, while the
...
const FALLBACK_FONTS = [
  ...
  'Pebble Nerd Font Symbols', // bundled PUA fallback for OMP/Powerline glyphs
