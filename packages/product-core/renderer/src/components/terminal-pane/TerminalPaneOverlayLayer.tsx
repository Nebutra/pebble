...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--pebble-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--pebble-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--pebble-terminal-overlay-probe width)')
