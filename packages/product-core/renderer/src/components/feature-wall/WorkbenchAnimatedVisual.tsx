...
// Why: the right-click menu needs the same icons as the real Pebble menu so the
...
const REVIEW_PROMPT = 'review packages/product-core/auth for missing error handling'
      ...
      <TermLine>
        ...
        <span className="ml-1.5 truncate text-muted-foreground">
          {translate(
            ...
            'throw packages/product-core/auth'
          )}
        </span>
      </TermLine>
      <TermLine>
