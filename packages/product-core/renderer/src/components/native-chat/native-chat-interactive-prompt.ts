...
// values from packages/product-core/shared, so both copies must stay in sync; parity is asserted by
// `packages/product-core/shared/native-chat-ask-parser-parity.test.ts`. The approval-card logic below
