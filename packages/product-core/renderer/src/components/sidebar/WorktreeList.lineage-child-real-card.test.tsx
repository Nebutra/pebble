...
vi.mock('@/hooks/useVirtualizedScrollAnchor', () => ({
  VIRTUALIZED_SCROLL_ANCHOR_RECORD_EVENT: 'pebble:test-record-scroll-anchor',
...
vi.mock('./WorktreeCardAgents', () => ({
  ...
  SUPPRESS_WORKTREE_LIST_SCROLL_ADJUSTMENT_EVENT: 'pebble:test-suppress-scroll-adjustment'
}))
...
vi.mock('./WorktreeContextMenu', () => ({
  ...
  CLOSE_ALL_CONTEXT_MENUS_EVENT: 'pebble:test-close-context-menus',
  WORKTREE_CONTEXT_MENU_SCOPE_ATTR: 'data-pebble-context-menu-scope',
...
function makeHostedReview(overrides: Partial<HostedReviewInfo> = {}): HostedReviewInfo {
  return {
    ...
    state: 'open',
    url: 'https://gitlab.com/acme/pebble/-/merge_requests/42',
    status: 'success',
