...
// Why this stays a synchronous default export: tests render it via
// renderToStaticMarkup (no Suspense support) and entry-reachable call sites
// pull the react-markdown pipeline lazily through CommentMarkdownLazy, so the
// heavy chunk stays out of the desktop-tauri entry without a lazy boundary here.
