...
const componentsRoot = path.join(repoRoot, 'packages/product-core/renderer/src/components')

const updateCapableCallers = new Map<string, readonly string[]>([
  [
    'packages/product-core/renderer/src/components/settings/OrchestrationPane.tsx',
    ['ORCHESTRATION_SKILL_UPDATE_COMMAND', 'installedCommand={orchestrationUpdateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/OrchestrationSetupCard.tsx',
    ['ORCHESTRATION_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/floating-terminal/FloatingTerminalOrchestrationDialog.tsx',
    ['ORCHESTRATION_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/ComputerUseSkillSetupPanel.tsx',
    ['COMPUTER_USE_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/EphemeralVmsPane.tsx',
    ['EPHEMERAL_VMS_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/CliSection.tsx',
    ['PEBBLE_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={cliSkillUpdateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/BrowserUsePane.tsx',
    ['PEBBLE_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={browserUseUpdateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/BrowserUseSkillStep.tsx',
    ['installedCommand={installedCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/feature-wall/BrowserUseSkillSetupCard.tsx',
    ['PEBBLE_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={updateCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/sidebar/LinearAgentSkillSetupPrompt.tsx',
    ['PEBBLE_LINEAR_SKILL_UPDATE_COMMAND', 'installedCommand={installedCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/sidebar/LinearAgentSkillSetupDialog.tsx',
    ['installedCommand={installedCommand}']
  ],
  [
    'packages/product-core/renderer/src/components/settings/MobileEmulatorAgentControlRow.tsx',
    ['PEBBLE_CLI_SKILL_UPDATE_COMMAND', 'installedCommand={cliSkillUpdateCommand}']
  ]
])
...
const installOnlyCallers = new Map<string, readonly string[]>([
  [
    'packages/product-core/renderer/src/components/emulator-pane/MobileEmulatorAgentSetupGuideSteps.tsx',
