...
type SettingsSidebarProps = {
  ...
  onPrepareSection: (sectionId: string) => void
  onSelectSection: (
    sectionId: string,
    modifiers: {
      metaKey: boolean
  ...
  return (
    ...
    >
      ...
      {showSetupGuideTopRow ? (
        <div
          className="border-b border-worktree-sidebar-border px-3 py-3"
          data-parity-volatile="settings-setup-guide"
        >
          <SettingsSetupGuideNavRow
            progress={setupGuideProgress}
            setupActive={setupActive}
            onPrepare={() => onPrepareSection('setup-guide')}
                  ...
                  .map((section) => {
                    ...
                    return (
                      <button
                        ...
                        onPointerEnter={() => onPrepareSection(section.id)}
                        onFocus={() => onPrepareSection(section.id)}
