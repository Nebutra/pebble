      ...
      {terminalOpen ? (
        ...
        >
          ...
          <Suspense
            fallback={
              <div
                className="mt-2 flex items-center justify-center rounded-md border border-border bg-editor-surface text-muted-foreground"
                style={{ height: terminalHeightPx ?? 320 }}
                aria-label={translate(
                  'auto.components.settings.AgentSkillSetupPanel.loadingTerminal',
                  'Loading terminal'
                )}
              >
