...
const EXAMPLE_PROMPTS: string[] = [
  'Using Pebble CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the Pebble CLI and tell me what's blocked.",
  'With Pebble CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
