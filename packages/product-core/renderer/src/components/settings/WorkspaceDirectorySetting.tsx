  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2">
        ...
        {showScopePicker && (
          <div className="flex items-center gap-1.5" data-parity-volatile="workspace-host-scope">
      ...
      {!editingHost && (
        <p className="text-xs text-muted-foreground">
          {translate(
            ...
            'Use a relative path (e.g. .pebble/worktrees) for a per-project location, or an absolute path for one shared folder.'
          )}
        </p>
      )}
    </SearchableSetting>
