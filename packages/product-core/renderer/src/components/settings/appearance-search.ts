...
export const getThemeEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose how Pebble looks in the app window.'
    ),
    keywords: [
...
export const getLanguageEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose the language used by the Pebble interface.'
    ),
    keywords: [
...
export const getTypographyEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'Choose the font used by the Pebble interface.'
    ),
    keywords: [
      ...
      ...translateSearchKeyword('auto.components.settings.appearance.search.1f2880a9d5', 'pebble'),
      ...translateSearchKeyword(
...
const getSystemTrayEntryCatalog = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    description: translate(
      ...
      'When enabled, closing the window keeps Pebble running in the system tray instead of quitting.'
    ),
    keywords: [
...
function shouldShowSystemTrayEntries(options: SystemTraySearchOptions): boolean {
  return (
    ...
    // Why: only a desktop shell owns the Windows tray; a browser can also report win32.
