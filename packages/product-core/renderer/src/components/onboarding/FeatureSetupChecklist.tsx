...
const FEATURE_SETUP_ROWS: readonly FeatureSetupRow[] = [
  {
    ...
    setupSummary: 'Enables browser use, prepares pebble-cli, and leaves cookies for Settings.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the Pebble CLI, opens permissions, and prepares the skill.',
  ...
  },
  {
    ...
    setupSummary: 'Registers the Pebble CLI, enables orchestration, and prepares the skill.',
