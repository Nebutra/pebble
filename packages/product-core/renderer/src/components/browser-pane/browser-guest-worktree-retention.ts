...
// Why 4: every hidden worktree that retains browser guests keeps one native
 ...
 * limit — a non-evictable one (automation/mobile controller mid-drive, or an
 * active download) stays retained over budget.
 */
