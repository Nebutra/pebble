...
export const webviewRegistry = new Map<string, BrowserPageWebview>()
...
type NativeManagedBrowserWebview = BrowserPageWebview & {
...
const dragPassthroughPreviousPointerEvents = new Map<BrowserPageWebview, string>()
...
function applyCurrentDragPassthroughToWebview(webview: BrowserPageWebview): void {
...
export function registerPersistentWebview(browserTabId: string, webview: BrowserPageWebview): void {
...
function moveFocusToRendererIfWebviewOwnsFocus(webview: BrowserPageWebview): boolean {
  ...
  // previously-frontmost app. Give focus back to Pebble's renderer first.
...
export function moveFocusToRendererBeforeWebviewDetach(webview: BrowserPageWebview): void {
