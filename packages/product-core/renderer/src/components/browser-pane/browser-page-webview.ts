...
export function ensureBrowserPageWebview({
...
}): { container: HTMLDivElement; created: boolean; webview: BrowserPageWebview } | null {
  ...
  webview = document.createElement('webview') as BrowserPageWebview
  ...
  webview.setAttribute('webpreferences', PEBBLE_BROWSER_GUEST_WEB_PREFERENCES_ATTRIBUTE)
  ...
  // normal browser behavior instead of leaking Pebble chrome through the guest.
