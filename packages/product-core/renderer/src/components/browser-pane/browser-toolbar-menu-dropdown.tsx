  ...
  return (
    <DropdownMenu modal={false} open={menuOpen} onOpenChange={onMenuOpenChange}>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuSub
          onOpenChange={(open) => {
            if (open && !cookieImportUnavailableReason) {
        ...
        >
          ...
          <DropdownMenuPortal>
            <DropdownMenuSubContent>
                          ...
                          <DropdownMenuSubContent>
                            {browser.profiles.map((profile) => (
                              <DropdownMenuItem
                                ...
                                onSelect={() =>
                                  onImportFromBrowser(browser.family, profile.directory)
                                }
                              >
                                {profile.name}
                              </DropdownMenuItem>
              ...
              {(!cookieImportUnavailableReason || !cookieFileImportUnavailableReason) && (
                <DropdownMenuSeparator />
              )}
              <DropdownMenuItem
