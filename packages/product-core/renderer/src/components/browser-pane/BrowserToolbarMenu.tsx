  ...
  return (
    <>
      <BrowserToolbarMenuDropdown
        ...
        cookieImportUnavailableReason={browserCookieImportUnavailableReason}
        cookieFileImportUnavailableReason={cookieFileImportUnavailableReason}
