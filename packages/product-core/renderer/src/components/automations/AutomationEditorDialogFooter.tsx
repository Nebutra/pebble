...
type AutomationEditorDialogFooterProps = {
  ...
  automationYamlHooksByRepoKey: Record<string, PebbleHooks | null>
...
export function AutomationEditorDialogFooter({
  ...
  return (
    <div className="border-t border-border/50 px-5 py-4">
      ...
      {/* Why: Hermes uses one compact footer row, while Pebble adds agent,
      ...
      >
        <div className="min-h-0">
          ...
          <AutomationSetupDecisionField
            createTarget={isHermesTarget ? 'hermes' : 'pebble'}
            draft={draft}
            repos={repos}
