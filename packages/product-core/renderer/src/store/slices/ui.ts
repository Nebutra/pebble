...
export const createUISlice: StateCreator<AppState, [], [], UISlice> = (set, get) => ({
  ...
  openSettingsPage: () => {
    ...
    // Why: Settings is a retained overlay. Keeping the workbench route stable
    // avoids broadcasting a settings detour to every activeView subscriber.
    set({ settingsPageOpen: true })
  },
