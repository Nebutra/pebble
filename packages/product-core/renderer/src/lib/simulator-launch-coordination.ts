...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'pebble:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'pebble:emulator-launch-failed'
