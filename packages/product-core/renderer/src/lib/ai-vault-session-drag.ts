...
export const AI_VAULT_SESSION_DRAG_TYPE = 'application/x-pebble-ai-vault-session'
export const AI_VAULT_SESSION_DRAG_START_EVENT = 'pebble-ai-vault-session-drag-start'
export const AI_VAULT_SESSION_DRAG_END_EVENT = 'pebble-ai-vault-session-drag-end'
...
export function writeAiVaultSessionDragData(
  ...
  // resume command instead of letting Pebble's pane drop layer handle it.
