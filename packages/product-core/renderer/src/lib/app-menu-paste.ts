...
export const APP_MENU_PASTE_EVENT = 'pebble-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Pebble already resolved.
  ...
  // Why: for text controls Pebble has already resolved ownership. Falling back
