...
type GuardedDelayerPrototype = MonacoDelayerInstance & {
  __pebbleDelayerCancellationGuardInstalled?: true
}
...
export function installMonacoDelayerCancellationGuard(): void {
  ...
  if (delayerPrototype.__pebbleDelayerCancellationGuardInstalled) {
    return
  }
  ...
  delayerPrototype.__pebbleDelayerCancellationGuardInstalled = true
}
