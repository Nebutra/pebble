...
describe('isWorkItemLookupText', () => {
  it('detects GitHub PR and issue URLs', () => {
    expect(isWorkItemLookupText('https://github.com/nebutra/pebble/pull/4900')).toBe(true)
    expect(isWorkItemLookupText('https://github.com/nebutra/pebble/issues/123')).toBe(true)
    expect(isWorkItemLookupText('  https://www.github.com/nebutra/pebble/pull/1 ')).toBe(true)
  })
