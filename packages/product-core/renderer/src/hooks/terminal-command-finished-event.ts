export const PEBBLE_TERMINAL_COMMAND_FINISHED_EVENT = 'pebble:terminal-command-finished'
...
export function dispatchTerminalCommandFinishedEvent(worktreeId: string): void {
  ...
  window.dispatchEvent(
    new CustomEvent<TerminalCommandFinishedEventDetail>(PEBBLE_TERMINAL_COMMAND_FINISHED_EVENT, {
      detail: { worktreeId }
    })
  )
}
