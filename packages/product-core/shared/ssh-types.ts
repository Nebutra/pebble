...
export type SshTarget = {
  id: string
  label: string
  /** Internal owner for targets that Pebble creates as implementation details.
 ...
 *  Keep in sync with packages/product-core/relay/port-scan-handler.ts — DetectedPort.
