import type { BrowserGrabPayload, BrowserGrabRect } from './browser-grab-types'
import { GRAB_BUDGET, GRAB_SAFE_ATTRIBUTE_NAMES, GRAB_SECRET_PATTERNS } from './browser-grab-types'
