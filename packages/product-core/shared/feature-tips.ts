...
export type FeatureTipId = 'voice-dictation' | 'pebble-cli' | 'cmd-j-palette'
...
export const FEATURE_TIPS = [
  ...
  },
  {
    ...
    description:
      'Speak into any focused pane and Pebble will transcribe it. Press the dictation shortcut to start and stop.',
    action: 'enable-voice',
