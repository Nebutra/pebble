// Per-step copy for the agents-orchestration tile in the Explore Pebble modal.
...
export const AGENTS_STEPS: readonly AgentsStep[] = [
  ...
  },
  {
    ...
    description: 'Enable agents to manage and coordinate Pebble workspaces to execute larger tasks.'
  },
  {
    id: 'usage',
    name: 'Usage',
