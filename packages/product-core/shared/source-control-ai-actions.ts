...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO: Record<string, SourceControlActionVariableInfo> =
  {
    ...
    stagedFiles: {
      ...
      example:
        'M packages/product-core/shared/source-control-ai.ts\nA packages/product-core/shared/source-control-ai-actions.ts'
    },
    stagedPatch: {
      description: 'The staged git patch used for commit-message generation.',
      example:
        'diff --git a/packages/product-core/app.ts b/packages/product-core/app.ts\n+addActionRecipeDefaults()'
    },
    baseBranch: {
