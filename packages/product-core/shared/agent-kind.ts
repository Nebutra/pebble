// Mapping from the renderer's `TuiAgent` union (every agent Pebble knows how
...
//
// Lives in `packages/product-core/shared/` (not the renderer) because main-side telemetry
