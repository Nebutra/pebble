 ...
 * sessions (#10832 / upstream #10841). Folding here knowingly treats canonically
 * equivalent names as one, which is exact on APFS but permissive on byte-exact
 * Linux/SSH hosts — an acceptable trade, since only comparison keys are affected.
 */
