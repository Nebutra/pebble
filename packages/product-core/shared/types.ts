...
export type Project = {
  ...
  /** Runtime-owned logical project identity used to group host-specific setup records. */
...
export type Repo = {
  ...
  /** Compatibility projection of the logical project's Windows runtime override. */
  localWindowsRuntimePreference?: LocalWindowsRuntimePreference
  /** Runtime-owned logical project identity used to group host-specific setup records. */
  logicalProjectId?: string
...
export type UpdateStatus =
  ...
  // Why: a release whose assets are still uploading is not a failure — it
...
export type PersistedUIState = {
  ...
  browserDefaultZoomLevel?: number /** Optional Kagi private-session link used only when Kagi is the search engine. */
