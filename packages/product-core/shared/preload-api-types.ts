/* eslint-disable max-lines -- Why: the shell-neutral desktop contract remains centralized while its domain interfaces are incrementally extracted into focused shared modules. */
import type {
...
import type { ReadClipboardTextOptions } from './clipboard-text'
import type { AppIdentity } from './app-identity'
import type { TerminalPaneSplitSource } from './feature-education-telemetry'
import type { TaskSourceContext } from './task-source-context'
import type { ProjectExecutionRuntimeResolution } from './project-execution-runtime'
import type { StartupCommandDelivery } from './codex-startup-delivery'
import type { SleepingAgentLaunchConfig } from './agent-session-resume'
import type { BrowserApi } from './browser-api-types'
import type { EmulatorApi } from './emulator-api-types'
import type { NativeChatApi } from './native-chat-api-types'
export type {
  BrowserApi,
  DetectedBrowserInfo,
  DetectedBrowserProfileInfo
} from './browser-api-types'
export type { EmulatorApi } from './emulator-api-types'
export type {
  NativeChatApi,
...
} from './native-chat-api-types'
import type { PreflightApi } from './preflight-api-types'
import type { PtyManagementApi } from './pty-management-api-types'
import type {
  DiagnosticsBundlePayload,
  DiagnosticsStatusPayload,
  DiagnosticsUploadPayload
} from './diagnostics-api-types'
export type {
  PreflightApi,
  PreflightRuntimeContext,
  PreflightStatus,
  RefreshAgentsResult
} from './preflight-api-types'
export type { PtyManagementApi, PtyManagementSession } from './pty-management-api-types'
export type {
  DiagnosticsBundlePayload,
  DiagnosticsStatusPayload,
  DiagnosticsUploadPayload
...
import type { WarpThemeImportPreview, WarpThemeImportSource } from './terminal-custom-themes'
...
import type { RuntimeAccessGrant } from './runtime-access-grants'
...
import type { AgentStatusIpcPayload, MigrationUnsupportedPtyEntry } from './agent-status-types'
import type { AgentInterruptInferenceRequest } from './agent-interrupt-intent'
import type {
...
import type { ShellOpenLocalPathResult } from './shell-open-types'
import type { SkillDiscoveryResult, SkillDiscoveryTarget } from './skills'
import type {
...
export type { ShellOpenLocalPathResult } from './shell-open-types'
...
} from './computer-use-permissions-types'
import type {
...
import type { GhAuthDiagnostic } from './github-auth-types'
import type {
  SshConnectionState,
  SshTarget,
  PortForwardEntry,
...
export type PreloadApi = {
   ...
   *  sites should import `track<N>()` from `packages/product-core/renderer/src/lib/telemetry.ts`
  ...
  ui: {
    ...
    confirmWindowClose: (requestId?: number) => void
  }
  runtime: {
