...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__pebble_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__pebbleBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-pebble-browser-annotation-overlay';
  const markerSize = 24;
