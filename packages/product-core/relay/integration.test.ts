...
import { SshChannelMultiplexer, type MultiplexerTransport } from '../shared/ssh-channel-multiplexer'
...
describe('Integration: Client Mux ↔ Relay Dispatcher', () => {
  ...
  describe('Filesystem operations', () => {
    ...
    it('readFileStream round-trip preserves a 12 MB binary file', async () => {
      ...
      const { readFileViaStream } = await import('../shared/ssh-filesystem-stream-reader')
