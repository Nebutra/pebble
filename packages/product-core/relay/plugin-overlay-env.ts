import { readShellStartupEnvVar } from '../shared/shell-startup-environment'
...
export function resolveOpenCodeSourceConfigDir(
  ...
  return firstNonEmpty(
    env.PEBBLE_OPENCODE_SOURCE_CONFIG_DIR,
...
export function resolvePiSourceAgentDir(
  ...
  const otherOverlayKey =
    kind === 'omp' ? 'PEBBLE_PI_CODING_AGENT_DIR' : 'PEBBLE_OMP_CODING_AGENT_DIR'
  ...
  // Why: a mismatched Pebble overlay shadow means this shell inherited the other
