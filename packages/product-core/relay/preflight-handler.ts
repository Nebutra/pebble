...
import { isPwshAvailable } from '../shared/powershell-availability'
import { isWslAvailable, listWslDistros } from '../shared/windows-subsystem-linux'
import { isGitBashAvailable } from '../shared/windows-git-bash'
...
const AGENT_PATH_PREFIX = '__PEBBLE_AGENT_PATH__'
