...
// src/main/ipc/preflight-remote-windows-terminal-capabilities.ts so the renderer
...
// isWslAvailable mirrors isWslAvailable in src/main/wsl.ts: `wsl.exe --status`
...
// isPwshAvailable mirrors isPwshAvailable in src/main/pwsh.ts: `pwsh.exe
...
// listWslDistros mirrors listWslDistros in src/main/wsl.ts: `wsl.exe --list
...
// normalizeWslListOutput + isUserWslDistro do in src/main/wsl.ts.
