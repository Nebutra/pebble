...
// isGitForWindowsBashPath regex in src/main/git-bash.ts. It rejects msys2/cygwin
...
// gitBashCandidatePaths mirrors getGitBashCandidatePaths in src/main/git-bash.ts:
