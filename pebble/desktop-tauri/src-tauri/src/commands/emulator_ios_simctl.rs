...
/// (pebble/go-runtime/internal/runtimecore/domain.go).
...
// Reserved for tap/swipe coordinate extraction once an idb/XCTest gesture
// backend lands (see run_gesture_gap in emulator_ios_provider.rs); unused
// until then, so this is intentional, not orphaned scaffolding.
#[allow(dead_code)]
