...
const terminalShortcutCapturedListeners = new Set<(data: { actionId: KeybindingActionId }) => void>()
...
export function emitTauriWorktreeHistoryNavigate(
  direction: TauriWorktreeHistoryDirection
): void {
