...
export const FIXTURE_COMMENTS: PRComment[] = [
  ...
  },
  {
    ...
    url: 'https://github.com/acme/pebble/pull/73#issuecomment-102'
  },
  {
    id: 103,
    author: 'carol',
...
export async function seedPRCommentsSidebarFixture(page: Page): Promise<PRCommentsSidebarSeed> {
  return page.evaluate(async (fixtureComments: PRComment[]) => {
    ...
    const pr: PRInfo = {
      ...
      state: 'open',
      url: `https://github.com/acme/pebble/pull/${prNumber}`,
    ...
    window.localStorage.setItem('pebble:pr-comment-presentation', 'cards')
