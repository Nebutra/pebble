...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    docsUrl: pebbleDocsUrl('/review/linear')
  },
  {
    id: 'tile-04',
    kind: 'media',
  ...
  },
  {
    ...
    docsUrl: pebbleDocsUrl('/browser/design-mode')
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    caption:
      'Run agents on a remote machine with the same Pebble editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
    posterPath: 'tile-06.poster.jpg',
    recordedAtPath: 'tile-06.recorded-at.json',
    owner: 'ssh-workspaces',
    docsUrl: pebbleDocsUrl('/ssh')
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: pebbleDocsUrl('/editing/file-explorer')
  },
  {
    id: 'tile-08',
    kind: 'media',
  ...
  },
  {
    ...
    kind: 'media',
    title: 'Pebble CLI',
    caption: 'Agents can drive Pebble too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
    posterPath: 'tile-09.poster.jpg',
    recordedAtPath: 'tile-09.recorded-at.json',
    owner: 'pebble-cli',
    docsUrl: pebbleDocsUrl('/cli/overview')
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: pebbleDocsUrl('/model/quick-open')
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: pebbleDocsUrl('/agents/usage-tracking')
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: pebbleDocsUrl('/editing/viewers')
  }
] as const
