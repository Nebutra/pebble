...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use Pebble's browser",
    subtitle: "Use Pebble's browser",
    description:
      'Browse your web app without leaving Pebble. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable Pebble CLI',
    subtitle: 'Enable Pebble CLI',
    description:
      'Register the Pebble shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into Pebble so you can start agent work without hunting for folders.'
  }
] as const
