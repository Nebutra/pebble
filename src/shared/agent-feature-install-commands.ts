export const PEBBLE_SKILLS_REPOSITORY_URL = 'https://github.com/nebutra/pebble'

export const PEBBLE_CLI_SKILL_NAME = 'pebble-cli'
export const COMPUTER_USE_SKILL_NAME = 'computer-use'
export const ORCHESTRATION_SKILL_NAME = 'orchestration'
export const EPHEMERAL_VMS_SKILL_NAME = 'pebble-per-workspace-env'
export const PEBBLE_LINEAR_SKILL_NAME = 'pebble-linear'
export const LINEAR_TICKETS_SKILL_NAME = 'linear-tickets'
export const LINEAR_AGENT_SKILL_NAMES = [PEBBLE_LINEAR_SKILL_NAME, LINEAR_TICKETS_SKILL_NAME] as const
...
export function buildAgentFeatureSkillInstallCommand(skillNames: readonly string[]): string {
  ...
  return `npx skills add ${PEBBLE_SKILLS_REPOSITORY_URL} --skill ${skillNames.join(' ')} --global`
}
...
export const PEBBLE_CLI_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  PEBBLE_CLI_SKILL_NAME
])

export const PEBBLE_CLI_SKILL_UPDATE_COMMAND =
  buildAgentFeatureSkillUpdateCommand(PEBBLE_CLI_SKILL_NAME)
...
export const PEBBLE_CLI_ORCHESTRATION_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  PEBBLE_CLI_SKILL_NAME,
  ORCHESTRATION_SKILL_NAME
])

export const PEBBLE_LINEAR_SKILL_INSTALL_COMMAND = buildAgentFeatureSkillInstallCommand([
  PEBBLE_LINEAR_SKILL_NAME
])

export const PEBBLE_LINEAR_SKILL_UPDATE_COMMAND =
  buildAgentFeatureSkillUpdateCommand(PEBBLE_LINEAR_SKILL_NAME)
