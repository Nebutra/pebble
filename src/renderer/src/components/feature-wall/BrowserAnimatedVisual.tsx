...
// Why: this animation tells the full Pebble story end-to-end — the user opens a
...
// Pebble's dropdown/popover primitives while staying inside the storyboard DOM.
