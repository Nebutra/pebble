...
// Mac-style terminal traffic-light dots — the signature of an Pebble terminal pane.
...
// Use Pebble's browser: a browser pane with a cursor grabbing one highlighted
