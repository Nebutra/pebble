...
function TabBarInner({
  ...
  const isWebClient = (globalThis as { __PEBBLE_WEB_CLIENT__?: boolean }).__PEBBLE_WEB_CLIENT__ === true
  ...
  return (
    <div
      ...
      // Pebble's editor. Terminal-pane drops need to keep inserting file paths
