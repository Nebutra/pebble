...
function releaseUrlForVersion(version: string | null): string {
  ...
  return version
    ? `https://github.com/nebutra/pebble/releases/tag/v${version}`
    ...
    status.state === 'error'
      ? isHttp2UpdateError
        ? {
            ...
            summary: 'Pebble can retry through HTTP/1.1 compatibility mode.',
        ...
        : {
            ...
            // failures (commonly GitHub-side) don't read as a bug in Pebble.
...
function SimpleCardContent({
  ...
  return (
    <div className="flex flex-col gap-2.5 p-3.5">
      ...
      <p className="text-sm text-muted-foreground">
        {translate('auto.components.UpdateCard.05ad78a6d1', 'Pebble v{{value0}} is ready.', {
          value0: version
        })}
      </p>
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-muted-foreground">
        {release
          ? release.description
          : translate('auto.components.UpdateCard.93794ea932', 'Pebble v{{value0}} is downloading.', {
              value0: version
            })}
      </p>
    ...
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-muted-foreground">
        {translate(
          ...
          "Pebble v{{value0}} is downloaded. Restart when you're ready.",
          { value0: version }
        )}
      </p>
