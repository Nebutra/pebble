...
const INSTALL_COMMAND = 'npx skills add https://github.com/nebutra/pebble --skill pebble-cli --global'
const UPDATE_COMMAND = 'npx skills update pebble-cli --global'
...
function panelProps(
  ...
  return {
    title: 'CLI skill',
    description: 'Enables agents to use Pebble workflows.',
...
describe('AgentSkillSetupPanel', () => {
  ...
  it('keeps update copy until the installed panel checks CLI prerequisites', () => {
    const html = renderPanel({
      ...
      preInstallNotice: 'Install the Pebble CLI before running agent skill setup.'
    })
