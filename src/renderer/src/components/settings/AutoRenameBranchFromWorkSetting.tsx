        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When an agent starts working in a new workspace, Pebble renames its auto-generated branch (e.g.'
            )}
            <code>
              {translate(
            ...
            {translate(
              ...
              ') to a short name summarizing the task. Only branches Pebble named itself are renamed, and never after they have been pushed.'
            )}
          </p>
        </div>
        <button
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  {translate(
                    ...
                    '. Pebble generates only the final segment, like'
                  )}
                  <code className="font-mono">
                    {translate(
