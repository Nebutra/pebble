...
const AGENT_PROMPT =
  'Use the pebble-per-workspace-env skill to set up a per-workspace environment for this repo.'
        ...
        <ul className="space-y-2">
          <WhatItem
            text={translate(
              ...
              'Writes the recipe & scripts for your provider — connected over an Pebble server or SSH.'
            )}
          />
          <WhatItem
            text={translate(
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Recipes your agent adds to pebble.yaml show up here, ready to launch a workspace on.'
              )}
            </p>
          </div>
          <Button
