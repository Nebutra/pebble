...
const PEBBLE_IOS_APP_STORE_URL = 'https://apps.apple.com/app/pebble-ide/id6766130217'
const PEBBLE_ANDROID_APK_URL =
  'https://github.com/nebutra/pebble/releases/download/mobile-android-v0.0.22/app-release.apk'
    ...
    <div className="space-y-4">
      ...
      >
        <p className="text-xs text-muted-foreground">
          {translate(
            ...
            'Control Pebble from your phone by scanning a QR code. Get the iOS app from the'
          )}{' '}
          <button
            type="button"
            onClick={() => void window.api.shell.openUrl(PEBBLE_IOS_APP_STORE_URL)}
          ...
          <button
            ...
            onClick={() => void window.api.shell.openUrl(PEBBLE_ANDROID_APK_URL)}
            className="cursor-pointer underline underline-offset-2 hover:text-foreground"
          >
      ...
      <SearchableSetting
        ...
        description={translate(
          ...
          'Show the Pebble Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Pebble Mobile shortcut in the sidebar.'
          )}
