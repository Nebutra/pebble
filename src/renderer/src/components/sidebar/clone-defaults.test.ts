...
describe('getDefaultCloneParent', () => {
  it('strips a POSIX workspaces suffix', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/pebble/workspaces')).toBe('/Users/mvanhorn/pebble')
  })
  ...
  it('strips a Windows workspaces suffix', () => {
    expect(getDefaultCloneParent('C:\\Users\\mvanhorn\\pebble\\workspaces')).toBe(
      'C:\\Users\\mvanhorn\\pebble'
    )
  })
  ...
  it('strips repeated trailing separators before matching the suffix', () => {
    expect(getDefaultCloneParent('D:\\pebble\\workspaces\\\\')).toBe('D:\\pebble')
  })

  it('does not strip a similar-looking final segment', () => {
    expect(getDefaultCloneParent('/Users/mvanhorn/pebble/project-workspaces')).toBe(
      '/Users/mvanhorn/pebble/project-workspaces'
    )
  })
})
  ...
  it('fills the local clone destination from the workspace directory', () => {
    expect(
      getCloneDestinationAutoFill({
        ...
        workspaceDir: '/Users/mvanhorn/pebble/workspaces',
        cloneStepAutoFilled: false
      })
    ).toEqual({ destination: '/Users/mvanhorn/pebble' })
  })
