            ...
            <div className="mp-step2-copy">
              ...
              <p className="mp-lead-sm">
                {translate(
                  ...
                  'Scan the QR with your phone or open the install link to grab Pebble Mobile.'
                )}
              </p>
        ...
        <div className={cn('mp-flow-screen', stepIdx === 1 && 'is-active')}>
          <div className="mp-step2-layout">
            <div className="mp-step2-copy">
              ...
              <p className="mp-lead-sm">
                {translate('auto.components.mobile.MobileHero.d1495e5e64', 'Open Pebble Mobile, tap')}{' '}
                <strong>
