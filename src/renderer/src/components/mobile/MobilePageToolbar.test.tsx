...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Pebble Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Pebble Mobile')
  })

  it('labels the restore action explicitly when Pebble Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
