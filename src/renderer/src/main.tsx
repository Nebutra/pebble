...
function RendererRoot(): React.JSX.Element {
  ...
  return (
    <RecoverableRenderErrorBoundary
      boundaryId="app.root"
      surface="app-root"
      title={translate('app.recoverableError.rootTitle', 'Pebble hit a renderer error.')}
      description={translate(
        'app.recoverableError.rootDescription',
        'The app shell could not finish rendering. Retry to remount it, or relaunch Pebble if the error persists.'
      )}
    >
      <App />
    </RecoverableRenderErrorBoundary>
