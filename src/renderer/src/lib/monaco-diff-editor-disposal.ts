...
type GuardedDiffEditor = editor.IStandaloneDiffEditor & {
  __pebbleDiffEditorDisposeGuardInstalled?: true
}

type GuardedEditorNamespace = MonacoDiffEditorNamespace['editor'] & {
  __pebbleDiffEditorFactoryGuardInstalled?: true
}
...
export function guardMonacoDiffEditorDispose(
  ...
  if (guardedDiffEditor.__pebbleDiffEditorDisposeGuardInstalled) {
    return diffEditor
  }
  ...
  guardedDiffEditor.__pebbleDiffEditorDisposeGuardInstalled = true
...
export function installMonacoDiffEditorDisposalGuard(
  ...
  if (editorNamespace.__pebbleDiffEditorFactoryGuardInstalled) {
    return
  }
  ...
  editorNamespace.__pebbleDiffEditorFactoryGuardInstalled = true
}
