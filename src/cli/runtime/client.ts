...
import { launchPebbleApp } from './launch'
...
export class RuntimeClient {
  ...
  constructor(
    ...
    remotePairingCode = process.env.PEBBLE_PAIRING_CODE ?? process.env.PEBBLE_REMOTE_PAIRING ?? null,
    ...
    if (this.remotePairing) {
      ...
      return {
        ...
        result: {
          ...
          // that this client machine has a local Pebble desktop process.
          app: {
            running: false,
            pid: null
          },
  ...
  async openPebble(timeoutMs = 15_000): Promise<RuntimeRpcSuccess<CliStatusResult>> {
    ...
    throw new RuntimeClientError(
      ...
      'Timed out waiting for Pebble to start. Run the Pebble app manually and try again.'
    )
  }
}
