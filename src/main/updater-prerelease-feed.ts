...
const ATOM_FEED_URL = 'https://github.com/nebutra/pebble/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/nebutra/pebble/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/nebutra\/pebble\/releases\/tag\/([^"]+)"/g
