...
export class RuntimeFileCommands {
  ...
  async openMobileFile(
    ...
    // (those live in pebble-environments.json). Passing it caused Unknown environment
    // errors on content load for CLI-initiated opens (via files.open from pebble cli
