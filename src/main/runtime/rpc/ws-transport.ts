...
// Why: the WebSocket transport enables mobile clients to connect to the Pebble
...
// tokens (validated by the message handler in PebbleRuntimeRpcServer) provide auth
...
export class WebSocketTransport implements RpcTransport {
  ...
  async start(): Promise<void> {
    ...
    // Why: when the preferred port is occupied (e.g. another Pebble instance is
  ...
  // and dispatch logic to the message handler set by PebbleRuntimeRpcServer.
