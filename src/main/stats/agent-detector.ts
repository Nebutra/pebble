 ...
 * pebble-runtime.ts normalizeTerminalChunk but avoids importing the runtime.
 */
...
export class AgentDetector {
  ...
  /**
   * Called on every PTY data chunk (from pebble-runtime.ts onPtyData).
  ...
  /**
   * Called when a PTY process exits (from pebble-runtime.ts onPtyExit).
   */
