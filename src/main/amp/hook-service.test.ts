...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'pebble-amp-home-'))
  ...
  it('installs an Pebble-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.PEBBLE_PANE_KEY')
  ...
  it('removes only Pebble-managed Amp plugin files', () => {
