  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/nebutra/pebble/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/nebutra/pebble/releases/download/v1.4.1/Pebble-1.4.1-arm64-mac.zip'
      ])
    }
  )
