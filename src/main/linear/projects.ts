...
const PEBBLE_PROJECT_DETAIL_FIELDS = `
  ${PEBBLE_PROJECT_FIELDS}
...
const PROJECTS_QUERY = `
  query PebbleLinearProjects($first: Int, $filter: ProjectFilter, $orderBy: PaginationOrderBy) {
...
const SEARCH_PROJECTS_QUERY = `
  query PebbleLinearProjectSearch($term: String!, $first: Int, $after: String) {
...
const PROJECT_QUERY = `
  query PebbleLinearProject($id: String!) {
    project(id: $id) {
      ${PEBBLE_PROJECT_DETAIL_FIELDS}
    }
  }
`

const CREATE_PROJECT_MUTATION = `
  mutation PebbleLinearProjectCreate($input: ProjectCreateInput!) {
...
const PROJECT_ISSUES_QUERY = `
  query PebbleLinearProjectIssues(
    $id: String!,
    $first: Int,
    $after: String,
...
const PROJECT_TEAMS_QUERY = `
  query PebbleLinearProjectTeams($id: String!, $first: Int, $after: String) {
    project(id: $id) {
...
const CUSTOM_VIEW_QUERY = `
  query PebbleLinearCustomView($id: String!) {
    customView(id: $id) {
      id
      name
      description
...
const CUSTOM_VIEW_ISSUES_QUERY = `
  query PebbleLinearCustomViewIssues(
    $id: String!,
    $first: Int,
    $after: String,
    $orderBy: PaginationOrderBy
...
const CUSTOM_VIEW_PROJECTS_QUERY = `
  query PebbleLinearCustomViewProjects($id: String!, $first: Int, $orderBy: PaginationOrderBy) {
    customView(id: $id) {
      id
      modelName
...
async function readIssueConnectionPages(
  ...
  while (items.length < limit) {
    ...
    // Pebble reads must follow cursors to show more than one backend page.
