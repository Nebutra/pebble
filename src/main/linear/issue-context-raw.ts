...
export const ISSUE_QUERY = `
  query PebbleAgentLinearIssue($id: String!) {
    issue(id: $id) {
      ${ISSUE_FIELDS}
    }
  }
...
export const SEARCH_QUERY = `
  query PebbleAgentLinearSearch($term: String!, $first: Int) {
...
export const COMMENTS_QUERY = `
  query PebbleAgentLinearIssueComments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const CHILDREN_QUERY = `
  query PebbleAgentLinearIssueChildren($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const ATTACHMENTS_QUERY = `
  query PebbleAgentLinearIssueAttachments($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
...
export const RELATIONS_QUERY = `
  query PebbleAgentLinearIssueRelations($id: String!, $first: Int, $after: String) {
    issue(id: $id) {
