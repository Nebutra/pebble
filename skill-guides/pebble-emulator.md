...
| Accessibility tree         | `pebble emulator ax [--device <id>]`          | Raw AX node tree, capped at 500 nodes. Frames use normalized 0..1 coordinates with a top-left origin; tap an element at `x + width/2`, `y + height/2`. |
