import type { RuntimeMobileSessionTabGroup } from '../../../packages/product-core/shared/runtime-types'
import type {
  TabGroupLayoutNode,
...
function readPersistedTabProps(value: unknown): RuntimeSessionTabProps | null {
  ...
  if (input.customTitle === null || typeof input.customTitle === 'string') {
    props.customTitle = input.customTitle
  }
