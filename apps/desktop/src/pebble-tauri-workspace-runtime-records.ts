import { LOCAL_EXECUTION_HOST_ID } from '../../../packages/product-core/shared/execution-host'
import type { LocalWindowsRuntimePreference } from '../../../packages/product-core/shared/project-execution-runtime'
import type {
  Repo,
  Worktree,
  WorktreeLineage,
...
export function mapRuntimeProjectToRepo(
  ...
  return {
    ...
    ...(project.logicalProjectId ? { logicalProjectId: project.logicalProjectId } : {}),
    ...(project.worktreeBasePath ? { worktreeBasePath: project.worktreeBasePath } : {}),
    ...(project.gitUsername ? { gitUsername: project.gitUsername } : {}),
    ...(project.issueSourcePreference
      ? { issueSourcePreference: project.issueSourcePreference }
      : {}),
    ...(project.projectHostSetupMethod
