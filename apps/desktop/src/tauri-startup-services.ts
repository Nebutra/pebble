...
import { startEmulatorAndroidProvider } from './tauri-emulator-android-provider-api'
import { startEmulatorIosProvider } from './tauri-emulator-ios-provider-api'
...
export async function waitForTauriStartupServices(
  ...
  await Promise.allSettled([
    ...
    settleStartupService('emulator-android-provider', startEmulatorAndroidProvider(), timeoutMs),
    settleStartupService('emulator-ios-provider', startEmulatorIosProvider(), timeoutMs)
  ])
}
