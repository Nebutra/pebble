...
import { getLoadingMicrocopy } from '../../../../../packages/product-core/shared/loading-microcopy'
import type { SshConnectionState } from '../../../../../packages/product-core/shared/ssh-types'
...
export default function MobileTasksScreen() {
  ...
  const [pebbleYamlTrustPrompt, setPebbleYamlTrustPrompt] = useState<PebbleYamlTrustPrompt | null>(
    null
  )
        ...
        {projectRepoNotInPebble ? (
          <View>
            <View style={styles.sheetHeader}>
              ...
              <Text style={styles.sheetSubtitle}>
                {projectRepoNotInPebble.owner}/{projectRepoNotInPebble.repo} is not added to Pebble.
