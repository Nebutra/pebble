...
import type { RuntimeMobileTerminalTheme } from '../../../../packages/product-core/shared/runtime-types'
...
(function() {
  ...
  function attachSurfaceEventHandlers(targetSurface) {
    if (!targetSurface || targetSurface.__pebbleSurfaceHandlersAttached) return;
    targetSurface.__pebbleSurfaceHandlersAttached = true;
