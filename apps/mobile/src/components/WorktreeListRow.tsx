...
import type { RuntimeWorktreeAgentRow } from '../../../../packages/product-core/shared/runtime-types'
...
type Props<T extends WorktreeListRowItem> = {
  ...
  // omits its own repo icon+name to avoid the redundant "📁 pebble" on every row.
  hideRepo?: boolean
