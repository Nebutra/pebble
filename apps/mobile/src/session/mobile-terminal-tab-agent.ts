import { stripLeadingAgentTitleDecorationOrEmpty } from '../../../../packages/product-core/shared/agent-title-decoration'
import { resolveExplicitTerminalTitleAgentType } from '../../../../packages/product-core/shared/terminal-title-agent-type'
import type { AgentStatusEntry } from '../../../../packages/product-core/shared/agent-status-types'
