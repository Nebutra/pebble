import {
  ...
  getBrokenChecks
} from '../../../../packages/product-core/shared/pr-checks-fix-prompt'
import { buildResolvePullRequestConflictsPrompt } from '../../../../packages/product-core/shared/source-control-conflict-prompts'
import type { PRCheckDetail } from '../../../../packages/product-core/shared/types'
