...
const DEFAULT_MARKETING_REPO = path.join(
  ...
  'repos',
  'Nebutra',
  'pebble-marketing-website'
)
const MARKETING_REPO = process.env.PEBBLE_MARKETING_REPO || DEFAULT_MARKETING_REPO
...
const TILES = [
  ...
  {
    id: 'tile-03',
    gifRelativePath: 'public/whats-new/pebble-github.gif',
    posterRelativePath: 'public/whats-new/posters/pebble-github.jpg'
  },
  {
    id: 'tile-04',
  ...
  {
    id: 'tile-05',
    gifRelativePath: 'public/whats-new/pebble-design-mode.gif',
    posterRelativePath: 'public/whats-new/posters/pebble-design-mode.jpg'
  },
  {
    id: 'tile-06',
  ...
  {
    id: 'tile-09',
    gifRelativePath: 'public/whats-new/pebble-cli-demo.gif',
    posterRelativePath: 'public/whats-new/posters/pebble-cli-demo.jpg'
  },
  {
    id: 'tile-10',
  ...
  {
    id: 'tile-12',
    gifRelativePath: 'public/whats-new/pebble-markdown-editor.gif',
    posterRelativePath: 'public/whats-new/posters/pebble-markdown-editor.jpg'
  }
]
