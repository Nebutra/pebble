...
export const JA_PHRASE_FIXES = [
  ...
  { pattern: /シャチ:\/\//g, replacement: 'pebble://', whenEnIncludes: 'pebble://' },
  ...
  { pattern: /崩壊させる/g, replacement: '折りたたむ', whenEnIncludes: 'Collapse Pebble' },
  ...
  { pattern: /再起動します/g, replacement: '再起動', whenEnIncludes: 'Restart Pebble' },
