...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /虎鲸:\/\//g, replacement: 'pebble://', whenEnIncludes: 'pebble://' },
    ...
    { pattern: /连接到Pebble/g, replacement: '连接到 Pebble', whenEnIncludes: 'Connect to Pebble' },
    {
      pattern: /开始使用Pebble/g,
      replacement: '开始使用 Pebble',
      whenEnIncludes: 'get started with Pebble'
    },
