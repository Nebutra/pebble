...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without an Pebble scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Pebble scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without an Pebble scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Pebble scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without an Pebble scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
