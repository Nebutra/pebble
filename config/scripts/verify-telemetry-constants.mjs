...
// Asserts that the telemetry compile-time constants — `PEBBLE_BUILD_IDENTITY`
// and `PEBBLE_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Pebble.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Pebble.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `PEBBLE_BUILD_IDENTITY` and `PEBBLE_POSTHOG_WRITE_KEY` with their
