...
This is the pre-work artifact for migrating Pebble to a localized UI. The goal is
...
The script scans `packages/product-core/renderer/src` by default. That is the primary UI surface.
