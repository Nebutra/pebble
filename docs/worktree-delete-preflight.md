...
- `removeManagedWorktree` runtime/RPC (`src/main/runtime/pebble-runtime.ts`)
...
3. Wire runtime ordering and failure mapping in `src/main/runtime/pebble-runtime.ts`; update `src/main/runtime/pebble-runtime.test.ts`.
