...
<p align="center">
  <a href="https://github.com/nebutra/pebble/stargazers"><img src="https://badgen.net/github/stars/nebutra/pebble?label=%E2%98%85" alt="GitHub スター数" /></a>
  <a href="https://github.com/nebutra/pebble/releases"><img src="../assets/readme-downloads.svg" alt="全リリースの合計ダウンロード数" /></a>
  <img src="https://badgen.net/github/license/nebutra/pebble" alt="ライセンス" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Pebble の Discord に参加" /></a>
  <a href="https://x.com/pebble_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="X で Pebble をフォロー" /></a>
...
<h3 align="center"><a href="https://www.nebutra.com/pebble/download"><ins>Pebble をダウンロード</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="並列ワークツリーでエージェントを実行する Pebble デスクトップアプリと、隅に表示された Pebble モバイル companion アプリ" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/pebble-ide/id6766130217) · [Android APK](https://github.com/nebutra/pebble/releases/download/mobile-android-v0.0.22/app-release.apk) · [ドキュメント →](https://www.nebutra.com/pebble/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Pebble デスクトップとモバイル companion アプリ" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://www.nebutra.com/pebble/docs/model/worktrees)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/model/worktrees"><picture><source srcset="../assets/feature-wall/parallel-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/parallel-worktrees.jpg" alt="並列ワークツリーのオーケストレーション" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/terminal"><picture><source srcset="../assets/feature-wall/terminal-splits.gif" type="image/gif"><img src="../assets/feature-wall/terminal-splits.jpg" alt="ターミナル分割" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://www.nebutra.com/pebble/docs/browser/design-mode)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/browser/design-mode"><picture><source srcset="../assets/feature-wall/design-mode.gif" type="image/gif"><img src="../assets/feature-wall/design-mode.jpg" alt="組み込みブラウザとデザインモード" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://www.nebutra.com/pebble/docs/review/linear)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Pebble の GitHub と Linear タスクワークフロー" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://www.nebutra.com/pebble/docs/ssh)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/ssh"><picture><source srcset="../assets/feature-wall/ssh-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/ssh-worktrees.jpg" alt="SSH 経由のリモートワークツリー" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
任意の Diff 行にコメントを付けてエージェントへ送り返せます — Pebble から離れずにレビュー、編集、コミットまで完結します。

[ドキュメント →](https://www.nebutra.com/pebble/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/review/annotate-ai-diff"><picture><source srcset="../assets/feature-wall/annotate-diff.gif" type="image/gif"><img src="../assets/feature-wall/annotate-diff.jpg" alt="AI が生成した Diff への注釈" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://www.nebutra.com/pebble/docs/editing/file-explorer)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/editing/file-explorer"><picture><source srcset="../assets/feature-wall/file-drag.gif" type="image/gif"><img src="../assets/feature-wall/file-drag.jpg" alt="ファイルや画像をエージェントのプロンプトへドラッグ" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
エージェント自身も Pebble を操作できます — `pebble worktree create`、`snapshot`、`click`、`fill` であらゆるワークフローをスクリプト化できます。

[ドキュメント →](https://www.nebutra.com/pebble/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.nebutra.com/pebble/docs/cli/overview"><picture><source srcset="../assets/feature-wall/pebble-cli.gif" type="image/gif"><img src="../assets/feature-wall/pebble-cli.jpg" alt="CLI から Pebble をスクリプト操作" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[クイックオープン](https://www.nebutra.com/pebble/docs/model/quick-open)** — フローを離れずに、ワークツリー、ファイル、エージェント、コマンド、リポジトリコンテキストを横断検索できます。
- **[アカウント切り替えと使用量トラッキング](https://www.nebutra.com/pebble/docs/agents/usage-tracking)** — Claude と Codex の使用量やレート制限のリセットを確認し、再ログインなしでアカウントを切り替えられます。
- **[リッチなリポジトリプレビュー](https://www.nebutra.com/pebble/docs/editing/markdown)** — Markdown、画像、PDF、リポジトリ文書をワークスペース内でプレビューできます。
- **[Computer Use](https://www.nebutra.com/pebble/docs/cli/computer-use)** — 実際の操作が必要なワークフローでは、エージェントにデスクトップアプリや画面上の UI を操作させられます。
- **[通知と未読ステータス](https://www.nebutra.com/pebble/docs/notifications)** — エージェントの完了や要対応をすぐに把握し、スレッドを未読に戻して後で確認できます。
- **その他、まだまだたくさん** — 毎日リリースしているので、このリストは常に追いついていません。本当の機能一覧は[チェンジログ](https://github.com/nebutra/pebble/releases)です。

---

## 対応するエージェント

**あらゆる CLI エージェント**で動作します — ターミナルで動くものなら、Pebble でも動きます。
...
- **[nebutra.com/pebble からダウンロード](https://www.nebutra.com/pebble/download)**
- またはビルドを直接入手: [macOS Apple Silicon](https://github.com/nebutra/pebble/releases/latest/download/pebble-macos-arm64.dmg) · [macOS Intel](https://github.com/nebutra/pebble/releases/latest/download/pebble-macos-x64.dmg) · [Windows (.exe)](https://github.com/nebutra/pebble/releases/latest/download/pebble-windows-setup.exe) · [Linux AppImage](https://github.com/nebutra/pebble/releases/latest/download/pebble-linux.AppImage) · [すべてのビルド](https://github.com/nebutra/pebble/releases/latest)
...
- **iOS:** [App Store からダウンロード](https://apps.apple.com/us/app/pebble-ide/id6766130217)
- **Android:** [APK をダウンロード](https://github.com/nebutra/pebble/releases/download/mobile-android-v0.0.22/app-release.apk)
...
- **Twitter / X:** アップデートやお知らせは **[@pebble_build](https://x.com/pebble_build)** をフォローしてください。
- **フィードバックとアイデア:** 私たちは高速にリリースしています。足りない機能がありますか？[機能リクエストを送信](https://github.com/nebutra/pebble/issues)してください。
- **プライバシー:** Pebble が収集する匿名の利用データとオプトアウトの方法については、[プライバシーとテレメトリーのドキュメント](https://www.nebutra.com/pebble/docs/telemetry)をご覧ください。
- **応援する:** 毎日のリリースを追うために、このリポジトリに[スター](https://github.com/nebutra/pebble)を付けてください。
...
<a href="https://github.com/nebutra/pebble/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nebutra/pebble" alt="Pebble のコントリビューター" />
</a>

## ライセンス

Pebble は [MIT License](../../LICENSE) の下で無料かつオープンソースです。
