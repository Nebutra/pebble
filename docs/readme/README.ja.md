...
<h3 align="center"><a href="https://pebble.nebutra.com/download"><ins>Pebble をダウンロード</ins></a></h3>
...
[iOS App Store](https://apps.apple.com/us/app/pebble-ide/id6766130217) · [Android APK](https://github.com/nebutra/pebble/releases/download/mobile-android-v0.0.22/app-release.apk) · [ドキュメント →](https://pebble.nebutra.com/docs/mobile)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="Pebble デスクトップとモバイル companion アプリ" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/model/worktrees)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/model/worktrees"><picture><source srcset="../assets/feature-wall/parallel-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/parallel-worktrees.jpg" alt="並列ワークツリーのオーケストレーション" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/terminal)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/terminal"><picture><source srcset="../assets/feature-wall/terminal-splits.gif" type="image/gif"><img src="../assets/feature-wall/terminal-splits.jpg" alt="ターミナル分割" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/browser/design-mode)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/browser/design-mode"><picture><source srcset="../assets/feature-wall/design-mode.gif" type="image/gif"><img src="../assets/feature-wall/design-mode.jpg" alt="組み込みブラウザとデザインモード" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/review/linear)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Pebble の GitHub と Linear タスクワークフロー" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/ssh)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/ssh"><picture><source srcset="../assets/feature-wall/ssh-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/ssh-worktrees.jpg" alt="SSH 経由のリモートワークツリー" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/review/annotate-ai-diff"><picture><source srcset="../assets/feature-wall/annotate-diff.gif" type="image/gif"><img src="../assets/feature-wall/annotate-diff.jpg" alt="AI が生成した Diff への注釈" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/editing/file-explorer)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/editing/file-explorer"><picture><source srcset="../assets/feature-wall/file-drag.gif" type="image/gif"><img src="../assets/feature-wall/file-drag.jpg" alt="ファイルや画像をエージェントのプロンプトへドラッグ" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[ドキュメント →](https://pebble.nebutra.com/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://pebble.nebutra.com/docs/cli/overview"><picture><source srcset="../assets/feature-wall/pebble-cli.gif" type="image/gif"><img src="../assets/feature-wall/pebble-cli.jpg" alt="CLI から Pebble をスクリプト操作" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[クイックオープン](https://pebble.nebutra.com/docs/model/quick-open)** — フローを離れずに、ワークツリー、ファイル、エージェント、コマンド、リポジトリコンテキストを横断検索できます。
- **[アカウント切り替えと使用量トラッキング](https://pebble.nebutra.com/docs/agents/usage-tracking)** — Claude と Codex の使用量やレート制限のリセットを確認し、再ログインなしでアカウントを切り替えられます。
- **[リッチなリポジトリプレビュー](https://pebble.nebutra.com/docs/editing/markdown)** — Markdown、画像、PDF、リポジトリ文書をワークスペース内でプレビューできます。
- **[Computer Use](https://pebble.nebutra.com/docs/cli/computer-use)** — 実際の操作が必要なワークフローでは、エージェントにデスクトップアプリや画面上の UI を操作させられます。
- **[通知と未読ステータス](https://pebble.nebutra.com/docs/notifications)** — エージェントの完了や要対応をすぐに把握し、スレッドを未読に戻して後で確認できます。
...
- **[pebble.nebutra.com からダウンロード](https://pebble.nebutra.com/download)**
...
- **プライバシー:** Pebble が収集する匿名の利用データとオプトアウトの方法については、[プライバシーとテレメトリーのドキュメント](https://pebble.nebutra.com/docs/telemetry)をご覧ください。
