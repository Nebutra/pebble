...
<p align="center">
  <a href="https://github.com/nebutra/pebble/stargazers"><img src="https://badgen.net/github/stars/nebutra/pebble?label=%E2%98%85" alt="Estrellas en GitHub" /></a>
  <a href="https://github.com/nebutra/pebble/releases"><img src="../assets/readme-downloads.svg" alt="Descargas totales en todas las versiones" /></a>
  <img src="https://badgen.net/github/license/nebutra/pebble" alt="Licencia" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Únete al Discord de Pebble" /></a>
  <a href="https://x.com/pebble_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Sigue a Pebble en X" /></a>
...
Funciona con **cualquier agente CLI** — si corre en una terminal, corre en Pebble.
...
- O descarga un build directamente: [macOS Apple Silicon](https://github.com/nebutra/pebble/releases/latest/download/pebble-macos-arm64.dmg) · [macOS Intel](https://github.com/nebutra/pebble/releases/latest/download/pebble-macos-x64.dmg) · [Windows (.exe)](https://github.com/nebutra/pebble/releases/latest/download/pebble-windows-setup.exe) · [Linux AppImage](https://github.com/nebutra/pebble/releases/latest/download/pebble-linux.AppImage) · [Todos los builds](https://github.com/nebutra/pebble/releases/latest)
...
- **iOS:** [Descargar desde App Store](https://apps.apple.com/us/app/pebble-ide/id6766130217)
- **Android:** [Descargar el APK](https://github.com/nebutra/pebble/releases/download/mobile-android-v0.0.22/app-release.apk)
...
¿Quieres contribuir o ejecutar Pebble localmente? Consulta nuestra guía [CONTRIBUTING.md](../../.github/CONTRIBUTING.md).

<a href="https://github.com/nebutra/pebble/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nebutra/pebble" alt="Contribuidores de Pebble" />
</a>

## Licencia

Pebble es libre y de código abierto bajo la [Licencia MIT](../../LICENSE).
