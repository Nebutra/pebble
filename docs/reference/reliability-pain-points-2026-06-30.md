...
The goal is to identify where Pebble is hurting, what engineering improvements would reduce repeat incidents, and what can fairly be said about attribution.
...
- [#6877](https://github.com/nebutra/pebble/issues/6877): macOS 1.4.106 nested `simcam` dylib is unnotarized and rejected by Gatekeeper.
- [#6874](https://github.com/nebutra/pebble/issues/6874): Windows `AppHangB1` when opening or activating a terminal session; runtime stuck in `stale_bootstrap`.
- [#6873](https://github.com/nebutra/pebble/issues/6873): likely duplicate or near-duplicate of #6874, though the issue metadata says macOS while the title/body describe Windows.
- [#6795](https://github.com/nebutra/pebble/issues/6795): app became very slow after an update; typing can lag by 2-5 seconds.
- [#6773](https://github.com/nebutra/pebble/issues/6773): cannot create a new terminal tab or agent; the tab opens and closes immediately.
- [#6655](https://github.com/nebutra/pebble/issues/6655): high `Pebble Helper (Renderer)` CPU on Mac Mini M4 causing severe UI/input lag.
- [#5787](https://github.com/nebutra/pebble/issues/5787): whole Windows window freezes; input dies in every pane; sessions close on click.
- [#5356](https://github.com/nebutra/pebble/issues/5356): session loss on first launch after upgrading from 1.4.65 to 1.4.68.
- [#5314](https://github.com/nebutra/pebble/issues/5314): Windows close button and Alt+F4 do nothing.

Closed `P0` issues worth keeping in the reliability history:

- [#6233](https://github.com/nebutra/pebble/issues/6233): Windows window fails to appear while the process runs in the background.
- [#6163](https://github.com/nebutra/pebble/issues/6163): Pebble-managed Codex `config.toml` duplicate key.
- [#5377](https://github.com/nebutra/pebble/issues/5377): native watcher main-process crash on macOS.
- [#5144](https://github.com/nebutra/pebble/issues/5144): Windows close-confirmation deadlock.
- [#5109](https://github.com/nebutra/pebble/issues/5109): sidebar agent status mismatch.
...
- [#6901](https://github.com/nebutra/pebble/issues/6901): garbled text.
- [#6764](https://github.com/nebutra/pebble/issues/6764): Windows terminal issues.
- [#6632](https://github.com/nebutra/pebble/issues/6632): display artifacts in Claude Code full-screen TUI.
- [#6144](https://github.com/nebutra/pebble/issues/6144): laggy Claude Code terminal scroll.
- [#5969](https://github.com/nebutra/pebble/issues/5969): remote-over-SSH Codex display artifacts.
- [#5345](https://github.com/nebutra/pebble/issues/5345): Windows/WSL scrolling causes duplicated or garbled text and content overlap.

### IME and International Text

- [#6905](https://github.com/nebutra/pebble/issues/6905): Vietnamese IME input broken in terminal.
- [#6765](https://github.com/nebutra/pebble/issues/6765): Linux Sogou Pinyin/fcitx only commits the first CJK character.
- [#6698](https://github.com/nebutra/pebble/issues/6698): Vietnamese Telex input loses characters.
- [#5921](https://github.com/nebutra/pebble/issues/5921): CJK characters duplicated in Pebble terminal on Windows.
- [#5262](https://github.com/nebutra/pebble/issues/5262): Arabic text rendering appears reversed or disconnected in terminal input.

### Paste and Clipboard

- [#5365](https://github.com/nebutra/pebble/issues/5365): terminal freezes for seconds when pasting long text on Windows.
- [#5358](https://github.com/nebutra/pebble/issues/5358): Windows paste preview collapses long text and cannot expand it.
- [#5919](https://github.com/nebutra/pebble/issues/5919): generic paste reliability issue.
- [#5960](https://github.com/nebutra/pebble/issues/5960): bad screen result when pasting links.
- [#6364](https://github.com/nebutra/pebble/issues/6364): pasting images into an agent CLI does not work using Remote Host.

### SSH, Remote Runtime, WSL, and Provider Boundaries

- [#6106](https://github.com/nebutra/pebble/issues/6106): SSH terminal loses pre-TUI shell output after Codex tab restore.
- [#6846](https://github.com/nebutra/pebble/issues/6846): remote PTY sessions do not stay alive on disconnect.
- [#6908](https://github.com/nebutra/pebble/issues/6908): WSL project added through UI does not discover branches/base refs, while CLI repo add works.
- [#6907](https://github.com/nebutra/pebble/issues/6907): Codex launched in a WSL worktree does not appear in agent status/sidebar.
- [#6916](https://github.com/nebutra/pebble/issues/6916): OMP launched in a WSL worktree has no live agent status.
- [#6032](https://github.com/nebutra/pebble/issues/6032): Remote Pebble Servers can lose host-scoped repo and project state.
- [#6688](https://github.com/nebutra/pebble/issues/6688): viewing a diff on remote host errors.
- [#6753](https://github.com/nebutra/pebble/issues/6753): remote-host GitHub merge errors.

### Agent, Tab, Session, and Sidebar State Drift

- [#6910](https://github.com/nebutra/pebble/issues/6910): active agent tabs duplicate UI sessions when switching repositories.
- [#6803](https://github.com/nebutra/pebble/issues/6803): multiple working agents thrash their order in the sidebar.
- [#6072](https://github.com/nebutra/pebble/issues/6072): mobile keeps showing old agent rows after terminals are closed.
- [#5913](https://github.com/nebutra/pebble/issues/5913): Pi compact agent row remains after closing its terminal tab.
- [#5718](https://github.com/nebutra/pebble/issues/5718): OMP sessions not showing up in Agent Session History or filter options.
- [#5404](https://github.com/nebutra/pebble/issues/5404): false "agent running" notifications persist after starting Claude Agents on VSSH/WSL.

### Mobile Terminal and Tabs

- [#5421](https://github.com/nebutra/pebble/issues/5421): iOS workspace tabs do not open.
- [#6756](https://github.com/nebutra/pebble/issues/6756): iOS terminal renders in cursive/italic font and continuously flickers.
- [#5628](https://github.com/nebutra/pebble/issues/5628): mobile resizing feature request, closely related to terminal fit/reflow reliability.

### Browser, Profile, and Embedded Runtime

- [#6923](https://github.com/nebutra/pebble/issues/6923): browser profiles do not isolate storage.
- [#6760](https://github.com/nebutra/pebble/issues/6760): floating browser cannot load any page.
- [#6268](https://github.com/nebutra/pebble/issues/6268): embedded-browser cookie/session limitation prevents Auth0 login.
- [#6875](https://github.com/nebutra/pebble/issues/6875): cannot copy Google Chrome cookies database.
- [#6652](https://github.com/nebutra/pebble/issues/6652): browser zoom broken.

### Startup, Install, and Platform Hangs

- [#5657](https://github.com/nebutra/pebble/issues/5657): macOS startup PATH probe can hang under Endpoint Security agents.
- [#5107](https://github.com/nebutra/pebble/issues/5107): Pebble opens very slowly on Windows 11 and leaves a residual process.
- [#5989](https://github.com/nebutra/pebble/issues/5989): Windows Defender blocks application during installation.

## Recent Reliability PR Context

The late-June reliability work clustered around the same few subsystems:

- New terminal tabs opening and immediately closing: [#6796](https://github.com/nebutra/pebble/pull/6796), [#6801](https://github.com/nebutra/pebble/pull/6801).
- Stale/frozen/blank terminals: [#6514](https://github.com/nebutra/pebble/pull/6514), [#6800](https://github.com/nebutra/pebble/pull/6800), [#6833](https://github.com/nebutra/pebble/pull/6833), [#6830](https://github.com/nebutra/pebble/pull/6830), [#6866](https://github.com/nebutra/pebble/pull/6866).
- PTY size and layout desync: [#6644](https://github.com/nebutra/pebble/pull/6644), [#6649](https://github.com/nebutra/pebble/pull/6649), [#6684](https://github.com/nebutra/pebble/pull/6684), [#6725](https://github.com/nebutra/pebble/pull/6725), [#6785](https://github.com/nebutra/pebble/pull/6785), [#6853](https://github.com/nebutra/pebble/pull/6853).
- Renderer/xterm crash hardening: [#6852](https://github.com/nebutra/pebble/pull/6852), [#6872](https://github.com/nebutra/pebble/pull/6872), [#6855](https://github.com/nebutra/pebble/pull/6855), [#6868](https://github.com/nebutra/pebble/pull/6868), [#6856](https://github.com/nebutra/pebble/pull/6856), [#6857](https://github.com/nebutra/pebble/pull/6857).
- Windows shell/spawn/input: [#6537](https://github.com/nebutra/pebble/pull/6537), [#6876](https://github.com/nebutra/pebble/pull/6876), [#6858](https://github.com/nebutra/pebble/pull/6858), [#6890](https://github.com/nebutra/pebble/pull/6890).
- Hidden/agent startup behavior: [#6824](https://github.com/nebutra/pebble/pull/6824), [#6798](https://github.com/nebutra/pebble/pull/6798), [#6836](https://github.com/nebutra/pebble/pull/6836).
...
| --- | --- | --- | --- | --- |
| [#6773](https://github.com/nebutra/pebble/issues/6773) | New terminal/agent tab opens and closes immediately | Dead-session reconciliation could treat a fresh PTY binding as absent from a stale `listSessions()` snapshot. This likely traces to the local dead-session reconcile path introduced for hidden exited panes in [#6514](https://github.com/nebutra/pebble/pull/6514). | [#6796](https://github.com/nebutra/pebble/pull/6796), [#6801](https://github.com/nebutra/pebble/pull/6801) | Newborn terminal lifecycle test: create shell and agent tabs while liveness reconciliation is in flight; assert the tab cannot be closed by an older snapshot. |
| [#5356](https://github.com/nebutra/pebble/issues/5356) | First launch after upgrade loses active floating/agent terminal sessions | Cold-restore relied on state that only versions after the fix could write, so users upgrading from pre-fix versions had no migration source. Issue text explicitly names [#5234](https://github.com/nebutra/pebble/pull/5234) and [#5240](https://github.com/nebutra/pebble/pull/5240). | Not fully closed in current open `P0` set | Upgrade fixture test: boot current app with persisted state from the last affected production version and assert active terminal/agent sessions are preserved or visibly recoverable. |
| [#5319](https://github.com/nebutra/pebble/issues/5319) | Linux/Wayland terminals render but stop accepting keyboard/scroll input | Wayland-aware GPU safeguard was removed in [#1344](https://github.com/nebutra/pebble/pull/1344), leaving eager GPU channel setup able to wedge terminal input on affected systems. | [#6557](https://github.com/nebutra/pebble/pull/6557) | Platform GPU matrix test: Linux Wayland launch with terminal WebGL/input smoke and assertion that GPU flags preserve input, not only rendering. |
| [#6233](https://github.com/nebutra/pebble/issues/6233) | Windows process runs but no window appears | Startup window reveal depended on Electron `ready-to-show`; if that event stalled, there was no fallback reveal or user-visible failure. | [#6462](https://github.com/nebutra/pebble/pull/6462) | Startup watchdog test: simulate missing `ready-to-show` on Windows and assert the app either reveals or exits with a clear recovery path. |
| [#6163](https://github.com/nebutra/pebble/issues/6163) | Pebble-managed Codex `config.toml` fails with duplicate `hooks.state` keys on Windows | Two TOML writers serialized the same Windows path key differently, and Pebble deduped textually rather than by decoded key. | [#6318](https://github.com/nebutra/pebble/pull/6318), follow-up [#6388](https://github.com/nebutra/pebble/pull/6388) bug-scan fix | Cross-writer config round-trip test: seed config with Codex-written literal Windows paths, run Pebble hook sync twice, then parse with a TOML parser and assert one decoded key. |
| [#6244](https://github.com/nebutra/pebble/issues/6244) | Headless-launched automation terminal showed only a bash prompt until unmount/remount | Hidden/background automation worktrees were not mounted early enough for output/replay to hydrate on first view. | [#6568](https://github.com/nebutra/pebble/pull/6568) | Headless automation mount test: launch background automation, wait for output, first-focus the tab, and assert output is already visible. |
| [#6331](https://github.com/nebutra/pebble/issues/6331) | WSL workspaces with UNC cwd hit `DaemonProtocolError` | Windows/WSL path handling crossed provider boundaries and daemon spawn assumptions. | [#6536](https://github.com/nebutra/pebble/pull/6536) | WSL UNC provider contract: add/open/delete workspace whose root is `\\wsl.localhost\...`; assert daemon and file operations use the right host/path semantics. |
| [#6336](https://github.com/nebutra/pebble/issues/6336) | Monorepo subfolder import opened the repo root instead of the selected subfolder | Git-root normalization leaked into the first-terminal cwd/user-facing workspace root behavior. | [#6574](https://github.com/nebutra/pebble/pull/6574) | Add-project matrix: repo root, monorepo subfolder, folder workspace, remote runtime; assert file tree root and first terminal cwd separately. |
| [#6147](https://github.com/nebutra/pebble/issues/6147) | Chinese full-width punctuation became half-width ASCII in terminal | IME/composition forwarding lacked coverage for macOS full-width punctuation and composition-owned text. | [#6417](https://github.com/nebutra/pebble/pull/6417) | IME matrix test: macOS CJK full-width punctuation, Vietnamese Telex, Linux fcitx/Sogou, Windows CJK; assert committed bytes and displayed cells. |
| [#5656](https://github.com/nebutra/pebble/issues/5656) / [#5653](https://github.com/nebutra/pebble/issues/5653) | Windows Claude Code prompt showed phantom/overwritten characters until resize | Rewrite-style terminal output did not reliably force visible row repaint for CR/CHA/erase updates. | [#6544](https://github.com/nebutra/pebble/pull/6544), [#6449](https://github.com/nebutra/pebble/pull/6449) | Terminal redraw fixture: feed CR, CHA, backspace, erase-line/screen and assert visible cells after each chunk without resize. |
| [#5161](https://github.com/nebutra/pebble/issues/5161) | PowerShell terminal failed to spawn with Windows error code 5 | Windows shell resolver handed ConPTY a bare `pwsh.exe`, which could resolve to an App Execution Alias stub. | [#6537](https://github.com/nebutra/pebble/pull/6537), [#6876](https://github.com/nebutra/pebble/pull/6876) | Windows shell resolution contract: auto and explicit PowerShell selections must resolve to real executables and skip WindowsApps aliases. |
| [#6270](https://github.com/nebutra/pebble/issues/6270) | Restoring agent sessions was not working for SSH/runtime use cases | Resume logic and runtime host restrictions did not cover SSH workspaces. | [#6685](https://github.com/nebutra/pebble/pull/6685) | Agent resume provider matrix: local, daemon, SSH, remote runtime, Windows shell; assert resume command is queued on the configured host/provider. |
| [#6852](https://github.com/nebutra/pebble/pull/6852) / [#6872](https://github.com/nebutra/pebble/pull/6872) | Terminal search could crash terminal surface on narrow viewports | xterm search decorations received invalid dimensions and threw through the terminal surface. | [#6852](https://github.com/nebutra/pebble/pull/6852), [#6872](https://github.com/nebutra/pebble/pull/6872) | xterm addon safety test: narrow viewport, zero/near-zero columns, wrapped matches, keyboard next/previous; assert addon errors are caught and pane remains usable. |
| [#6855](https://github.com/nebutra/pebble/pull/6855) | xterm web-link provider `RangeError` could kill the Windows renderer | Link provider ran synchronously inside xterm with no guard around pathological wrapped lines. | [#6855](https://github.com/nebutra/pebble/pull/6855) | Addon boundary policy: all xterm addon callbacks are guarded and failure disables only that addon for that pane. |
| [#6853](https://github.com/nebutra/pebble/pull/6853) | Split-right PTY stayed at `0x0` and rendered a white screen | Deferred spawn measured an unlaid-out pane; post-spawn reconcile could terminate before forwarding a usable size. | [#6853](https://github.com/nebutra/pebble/pull/6853) | Split spawn invariant: visible panes must never keep PTY size `0x0`; fallback size must be forwarded if measurement is unavailable. |

The repeated pattern is not one person repeatedly making the same mistake. It is that Pebble does not yet have enough executable contracts around lifecycle, provider boundaries, terminal sizing, xterm safety, platform shell behavior, and upgrade state.
...
[PR #1344](https://github.com/nebutra/pebble/pull/1344) replaced global GPU opt-ins with VS Code-style GPU startup flags and terminal GPU acceleration settings. The PR description cites reference behavior and local tests, but it does not show the later, stricter Brennan PR process markers used in the June reliability fixes.

What still got through:

- The change removed or bypassed the Wayland-aware GPU safeguard later identified by [PR #6557](https://github.com/nebutra/pebble/pull/6557).
...
- Reference implementations are useful context, but factory review must still require Pebble-specific platform hazards to be named and tested or accepted.
...
- **Old-version restore corpus**: keep immutable user-data fixtures from the last affected production versions, especially pre-#5232 session state. Boot current Pebble against those fixtures and assert every persisted PTY/agent record is preserved, resumed once, warm-reattached once, or visibly marked unrecoverable. Include second restart after current Pebble writes upgraded state.
...
The later fixes, especially [#6801](https://github.com/nebutra/pebble/pull/6801), show the right shape: root-cause description, happens-before proof, explicit `auto-design-review-fix`, completeness verification, code-review loop, `brennan-test-changes`, and targeted tests for the stale snapshot/newborn binding race. [#6852](https://github.com/nebutra/pebble/pull/6852), [#6853](https://github.com/nebutra/pebble/pull/6853), and [#6855](https://github.com/nebutra/pebble/pull/6855) also show good local invariant tests around xterm addon throws and PTY `0x0` sizing.
...
Any addon that can throw synchronously or produce invalid dimensions can take down the workbench unless Pebble wraps it defensively.
...
- Preserve `pebble terminal read` pagination, cursor metadata, bounded preview behavior, partial-line handling, truncation flags, and total counts when changing terminal buffering.
...
- Internal factory skill update PR: https://github.com/nebutra/pebble-internal/pull/491
...
- [#5356](https://github.com/nebutra/pebble/issues/5356), session loss on first launch after upgrading from 1.4.65 to 1.4.68, explicitly names PRs [#5234](https://github.com/nebutra/pebble/pull/5234) and [#5240](https://github.com/nebutra/pebble/pull/5240). Local git history shows both PRs were authored by Jinwoo Hong. Count: Jinwoo 1 confirmed open `P0` regression chain.
- [#5319](https://github.com/nebutra/pebble/issues/5319), Linux/Wayland terminal input freeze, is closed, but the fixing PR [#6557](https://github.com/nebutra/pebble/pull/6557) says the Wayland-aware GPU path had been removed in [#1344](https://github.com/nebutra/pebble/pull/1344). Local git history shows #1344 was authored by Neil. Count: Neil 1 confirmed closed `P1` regression chain.

### Likely Regression Chains

- [#6773](https://github.com/nebutra/pebble/issues/6773), new terminal/agent tabs opening and immediately closing, was fixed by [#6796](https://github.com/nebutra/pebble/pull/6796) and [#6801](https://github.com/nebutra/pebble/pull/6801). Those PRs identify the dead-session reconciler as the cause. Local git history shows [#6514](https://github.com/nebutra/pebble/pull/6514), which introduced the focused dead-session reconcile module for hidden exited panes, was authored by Brennan Benson. Count: Brennan 1 likely open `P0` regression chain.
...
Most open `P0`/`P1` issues do not identify an introducing PR. Treating those as individual blame would be misleading. The stronger conclusion is that Pebble has systemic reliability gaps around terminal/session lifecycle, provider contracts, PTY sizing, and upgrade/startup flows.
