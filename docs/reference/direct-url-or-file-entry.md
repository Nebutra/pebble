...
1. A URL to open an Pebble browser tab.
...
- Do not open external URLs outside Pebble.
...
- No active worktree: disable the entry, including URL entry, because Pebble browser tabs are worktree-scoped.
