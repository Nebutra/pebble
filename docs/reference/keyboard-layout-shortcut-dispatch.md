...
1. Pebble commands that act on terminal UI, such as copy selection, paste, search, clear,
...
This boundary is intentional. It lets non-US layouts use Pebble commands naturally while
