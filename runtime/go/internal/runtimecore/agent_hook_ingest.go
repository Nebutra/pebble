...
// agentHookProtocolVersion matches the shared Pebble managed-hook contract so
// every desktop shell and remote relay speaks the same handshake to Go.
...
// agentHookSessionEnv owns the runtime side of the shared managed-hook contract:
// scripts require PORT, TOKEN, and PANE_KEY, and attribute events via LAUNCH_TOKEN.
