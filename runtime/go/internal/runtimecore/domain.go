...
const (
	...
	CapabilitySharedControl Capability = "shared-control"
)
...
type Project struct {
	...
	LogicalProjectID              string                         `json:"logicalProjectId,omitempty"`
	WorktreeBasePath              string                         `json:"worktreeBasePath,omitempty"`
	GitUsername                   string                         `json:"gitUsername,omitempty"`
	IssueSourcePreference         string                         `json:"issueSourcePreference,omitempty"`
	ProjectHostSetupMethod        string                         `json:"projectHostSetupMethod,omitempty"`
	ProjectGroupID                *string                        `json:"projectGroupId,omitempty"`
	ProjectGroupOrder             *float64                       `json:"projectGroupOrder,omitempty"`
	SortOrder                     int64                          `json:"sortOrder,omitempty"`
	LocalWindowsRuntimePreference *LocalWindowsRuntimePreference `json:"localWindowsRuntimePreference,omitempty"`
	CreatedAt                     time.Time                      `json:"createdAt"`
	UpdatedAt                     time.Time                      `json:"updatedAt"`
}

type LocalWindowsRuntimePreference struct {
...
type Worktree struct {
	...
	WorkspaceStatus                string                         `json:"workspaceStatus,omitempty"`
	SparseDirectories              []string                       `json:"sparseDirectories,omitempty"`
	SparseBaseRef                  string                         `json:"sparseBaseRef,omitempty"`
	SparsePresetID                 string                         `json:"sparsePresetId,omitempty"`
	CreatedWithAgent               string                         `json:"createdWithAgent,omitempty"`
	PendingFirstAgentMessageRename bool                           `json:"pendingFirstAgentMessageRename,omitempty"`
	AutomationProvenance           *AutomationWorkspaceProvenance `json:"automationProvenance,omitempty"`
...
type PreservedBranchCleanupTicket struct {
...
type StartSessionRequest struct {
	...
	Cols        int      `json:"cols,omitempty"`
	Rows        int      `json:"rows,omitempty"`
	// Environment carries explicit per-session overrides such as an isolated
	// CODEX_HOME. Values are merged by key onto the runtime process environment.
...
type TailSessionResponse struct {
	...
	Transcript TerminalTranscriptSnapshot `json:"transcript"`
}

type TerminalTranscriptSnapshot struct {
	CompletedLines     []string `json:"completedLines"`
	PartialLine        string   `json:"partialLine"`
	CompletedLineCount uint64   `json:"completedLineCount"`
	BufferTruncated    bool     `json:"bufferTruncated"`
}

type TerminalTranscriptRead struct {
...
type WorktreeBaseStatusEvent struct {
...
type GitHugeFolderRequest struct {
	ProjectID  string `json:"projectId"`
	WorktreeID string `json:"worktreeId,omitempty"`
