...
type persistedState struct {
	...
	SparsePresets          []SparsePreset                 `json:"sparsePresets,omitempty"`
	ProjectHostSetups      []ProjectHostSetup             `json:"projectHostSetups,omitempty"`
	ProjectGroups          []ProjectGroup                 `json:"projectGroups"`
	FolderWorkspaces       []FolderWorkspace              `json:"folderWorkspaces"`
	Worktrees              []Worktree                     `json:"worktrees"`
	PreservedBranchCleanup []PreservedBranchCleanupTicket `json:"preservedBranchCleanup,omitempty"`
	...
	RemoteAgentDetections  []RemoteAgentDetection         `json:"remoteAgentDetections,omitempty"`
	...
	AccountsSnapshot       json.RawMessage                `json:"accountsSnapshot,omitempty"`
	LegacySharedControl    LegacySharedControlState       `json:"legacySharedControl,omitempty"`
}
