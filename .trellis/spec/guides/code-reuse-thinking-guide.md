...
When adding new files to `packages/product-core/templates/trellis/scripts/`:

**Single registration point**: `packages/product-core/templates/trellis/index.ts`
...
grep -l "newFileName" packages/product-core/templates/trellis/index.ts  # Should match
```
